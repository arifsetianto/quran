                ...
                @if($quran->verse === 1)
                    @if($chapter->id !== 1 && $chapter->id !== 9)
                        <div class="text-center">
                            <p class="text-3xl font-normal text-gray-900 dark:text-gray-300 quran-text leading-loose">بِسْمِ ٱللَّهِ ٱلرَّحْمَـٰنِ ٱلرَّحِيمِ</p>
                        </div>
                        ...
                        <div class="mt-8">
                            ...
                            @if($showComment)
                                @foreach($quran->comments as $comment)
                                    <div
                                        class="max-w mt-4 p-4 bg-blue-950/25 rounded-lg dark:bg-gray-800 dark:border-gray-700">
