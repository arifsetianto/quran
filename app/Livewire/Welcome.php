            ...
            [
                'menu' => [
                    ...
                    [
                        ...
                        'redirect_route' => route('get-quran-by-page', ['page' => 1, 'showTranslation' => true, 'showComment' => true]),
                        'icon'           => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="w-7 h-7 stroke-blue-500">
                    ...
                    [
                        ...
                        'redirect_route' => route('get-quran-by-subject', ['subject' => 1, 'showTranslation' => true, 'showComment' => true]),
                        'icon'           => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="w-7 h-7 stroke-blue-500">
